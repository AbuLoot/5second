...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('joystick-admin.posts.index', compact('posts'));
    }
    ...
    public function create($lang)
    {
        ...
        return view('joystick-admin.posts.create', ['pages' => $pages]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $post->slug = (empty($request->slug)) ? str_slug($request->title) : $request->slug;
    ...
    public function edit($lang, $id)
    {
        ...
        return view('joystick-admin.posts.edit', compact('Post', 'pages'));
    }
