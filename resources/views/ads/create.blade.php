    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <form action="{{ route('products.store', $lang) }}" method="post" enctype="multipart/form-data">
          {!! csrf_field() !!}
          <div class="box_detail- padding_bottom- card">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <!-- <div class="form-group">
                    <label for="area">Адрес</label>
                    <input type="text" class="form-control" id="area" name="area" minlength="2" maxlength="80" value="{{ (old('area')) ? old('area') : '' }}">
                  </div>
                  <div class="form-group">
                    <label for="latitude">Долгота</label>
                    <input type="text" class="form-control" id="latitude" name="latitude" maxlength="10" value="{{ (old('latitude')) ? old('latitude') : '' }}">
                  </div>
                  <div class="form-group">
                    <label for="longitude">Широта</label>
                    <input type="text" class="form-control" id="longitude" name="longitude" maxlength="10" value="{{ (old('longitude')) ? old('longitude') : '' }}">
                  </div> -->
                </div>
              </div>
              <div class="row">
