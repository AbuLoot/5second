        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="area" name="area" minlength="2" maxlength="80" value="{{ (old('area')) ? old('area') : $product->area }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="latitude">Долгота</label>
              <input type="text" class="form-control" id="latitude" name="latitude" maxlength="10" value="{{ (old('latitude')) ? old('latitude') : $product->latitude }}">
            </div>
            <div class="form-group">
              <label for="longitude">Широта</label>
              <input type="text" class="form-control" id="longitude" name="longitude" maxlength="10" value="{{ (old('longitude')) ? old('longitude') : $product->longitude }}">
            </div>
          </div>
        </div>
        <div class="row">
