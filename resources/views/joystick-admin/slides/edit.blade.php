...
@section('content')
  ...
  <p class="text-right">
    <a href="/{{ $lang }}/admin/slides" class="btn btn-primary btn-sm">Назад</a>
  </p>
  <form action="{{ route('slides.update', [$lang, $item->id]) }}" method="post" enctype="multipart/form-data">
